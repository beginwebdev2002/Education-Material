export const ADMIN_NAV_LINKS = [
  { path: '/admin/overview', label: 'admin.nav.overview', icon: 'fa-solid fa-chart-pie' },
  { path: '/admin/users', label: 'admin.nav.users', icon: 'fa-solid fa-users-cog' },
  { path: '/admin/materials', label: 'admin.nav.materials', icon: 'fa-solid fa-file-invoice' },
  { path: '/admin/autocomplete', label: 'admin.nav.autocomplete', icon: 'fa-solid fa-list-ul' },
