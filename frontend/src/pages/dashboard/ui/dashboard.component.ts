...
import { Material, MaterialListComponent, MaterialService } from '@entities/material';
import { IllustrationComponent } from '@shared/ui';
import { MaterialUploadFormComponent } from '@features/material-upload';
...
@Component({
  ...
  imports: [IllustrationComponent, MaterialUploadFormComponent, MaterialListComponent],
})
